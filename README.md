...
- **block** → block YouTube
- **suggest_break** → nudge the user to take a break
...
|---|---|---|
| `task_casual` | Casual User | Easy |
| `task_addict` | Addicted User | Medium |
| `task_binge_procrastinator` | Binge Procrastinator | Hard |
...
```json
POST /step
{ "action": "allow" }   // or "block" or "suggest_break"
```
...
| User tired / long session | suggest_break | +0.6–0.7 |
